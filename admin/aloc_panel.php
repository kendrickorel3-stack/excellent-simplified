...
@$conn->query("ALTER TABLE questions ADD COLUMN IF NOT EXISTS aloc_year VARCHAR(10) DEFAULT NULL");
@$conn->query("ALTER TABLE questions ADD COLUMN IF NOT EXISTS aloc_source VARCHAR(30) DEFAULT NULL");
